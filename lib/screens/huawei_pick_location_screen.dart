...
class HuaweiPickLocationScreen extends StatefulWidget {
  //const GooglePickLocationScreen({Key? key}) : super(key: key);

  @override
  _HuaweiPickLocationScreenState createState() => _HuaweiPickLocationScreenState();
}

class _HuaweiPickLocationScreenState extends State<HuaweiPickLocationScreen> {
